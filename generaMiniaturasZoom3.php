...
// http://192.168.0.200/serGIS1/generaMiniaturasZoom3.php?nombre=map4&num=128&num2=128&doGenerate=Generate
...
for ($y=1,$yy=1;$y<=$numy;$y+=2,$yy++)
{
	...
	$im2 = @imagecreatefromjpeg($nombre."/6/".$x."-".$y.".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 0, 0, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/6/".($x+1)."-".$y.".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 128, 0, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/6/".$x."-".($y+1).".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 0, 128, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/6/".($x+1)."-".($y+1).".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 128, 128, 0, 0, 128, 128, 256, 256);
	
	imagejpeg($miniatura, $nombre.'/7/'.$xx.'-'.$yy.".jpg");    // Salva el Zoom de los 4 sectores reunidos
/*
	imagecopy($im, $im2, 0, 0, 0, 0, 180, 180);
...
for ($y=1,$yy=1;$y<=$numy;$y+=2,$yy++)
{
	...
	$im2 = @imagecreatefromjpeg($nombre."/7/".$x."-".$y.".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 0, 0, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/7/".($x+1)."-".$y.".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 128, 0, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/7/".$x."-".($y+1).".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 0, 128, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/7/".($x+1)."-".($y+1).".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 128, 128, 0, 0, 128, 128, 256, 256);
	
	imagejpeg($miniatura, $nombre.'/8/'.$xx.'-'.$yy.".jpg");    // Salva el Zoom de los 4 sectores reunidos
/*
	imagecopy($im, $im2, 0, 0, 0, 0, 180, 180);
...
for ($y=1,$yy=1;$y<=$numy;$y+=2,$yy++)
{
	...
	$im2 = @imagecreatefromjpeg($nombre."/8/".$x."-".$y.".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 0, 0, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/8/".($x+1)."-".$y.".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 128, 0, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/8/".$x."-".($y+1).".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 0, 128, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/8/".($x+1)."-".($y+1).".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 128, 128, 0, 0, 128, 128, 256, 256);
	
	imagejpeg($miniatura, $nombre.'/9/'.$xx.'-'.$yy.".jpg");    // Salva el Zoom de los 4 sectores reunidos
/*
	imagecopy($im, $im2, 0, 0, 0, 0, 180, 180);
//	imagestring($im, $fuente, 12, 10,  $x.'-'.$y.'a', $color_texto);
	imagestring($im, 5, 7, 10,  $x.'-'.$y.'a', $color_texto);
...
for ($y=1,$yy=1;$y<=$numy;$y+=2,$yy++)
{
	...
	$im2 = @imagecreatefromjpeg($nombre."/9/".$x."-".$y.".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 0, 0, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/9/".($x+1)."-".$y.".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 128, 0, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/9/".$x."-".($y+1).".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 0, 128, 0, 0, 128, 128, 256, 256);

	$im2 = @imagecreatefromjpeg($nombre."/9/".($x+1)."-".($y+1).".jpg");   // carga la foto del sector actual
//	    or die("Cannot Initialize new GD image stream !!");
	imagecopyresampled($miniatura, $im2, 128, 128, 0, 0, 128, 128, 256, 256);
	
	imagejpeg($miniatura, $nombre.'/10/'.$xx.'-'.$yy.".jpg");    // Salva el Zoom de los 4 sectores reunidos
/*
	imagecopy($im, $im2, 0, 0, 0, 0, 180, 180);
//	imagestring($im, $fuente, 12, 10,  $x.'-'.$y.'a', $color_texto);
	imagestring($im, 5, 7, 10,  $x.'-'.$y.'a', $color_texto);
...
<form action="generaMiniaturasZoom3.php" method="get" name="generatorForm" id="generatorForm" >
